...
class SolarPanelProductionTable extends BaseWidget
{
    protected static ?string $heading = 'Overzichtstabel Opbrengst Zonnepanelen';
    ...
    private function calculateMonthlyConsumption(
        ...
        $waterIn = $this->getMeterDifference($zonnepanelenId, $startOfMonth, $endOfMonth);
