<div class="privacy-exempt">
    <x-filament-widgets::widget :widget="$this" class="fonds-koersontwikkeling-chart">
        <x-filament::section>
            {{-- Header met filter --}}
            ...
            <div style="position: relative; height: 400px; width: 100%;">
                <canvas id="fondsKoersChart" wire:key="chart-{{ $filter }}"></canvas>
            </div>
